			...
			<section id="about" class="about">
				...
				<div class="container">
					...
					<div class="about-content" style="text-align:justify; padding-top:10px;">
						...
						<form method="post" action="components/insert-review.php" role="form" class="php-email-form" enctype="multipart/form-data" >
							
							<div class="mb-3" style="">
								<h4>Confirmation of Asynchronous Classes </h4>
								<p style="margin-top:10px; font-size:11pt;">
									Hi, <b><?php echo $faculty_name; ?></b>. Please review your registered classes:
								</p>
							</div>
							
							<div class="mb-3 info-panel" >
								<h4>Prelim Schedule (September 15, 2022) </h4>
								...
								<?php 
									$i = 0;
									$query1 = $query."AND term_period = '1'";
									$result1 = mysqli_query($con, $query1);							
									if(mysqli_num_rows($result1) > 0){
										while($row1 = mysqli_fetch_array($result1)){
											$i = $i + 1;
											$subject_code = $row1['subject_code'];
											$subject_desc = $row1['subject_desc'];
											$section = $row1['section'];
											$schedule_time1 = $row1['schedule_time1'];
											$schedule_time2 = $row1['schedule_time2'];
									
								?>
											<tr >  
												<td colspan="2"><b>Class Details #<?php echo $i; ?></b></td>  
											...
											<tr>  
												...
												<td>
													<?php echo $schedule_time1; ?>
												</td>
											</tr>
											<tr>  
												<td style="vertical-align: middle;">End Time</td>  
												<td>
													<?php echo $schedule_time2; ?>
												</td>
											</tr>
								...
								<h4>Midterm Schedule (October 25, 2022) </h4>
								...
								<?php 
									$i = 0;
									$query2 = $query."AND term_period = '2'";
									$result2 = mysqli_query($con, $query2);							
									if(mysqli_num_rows($result2) > 0){
										while($row2 = mysqli_fetch_array($result2)){
											$i = $i + 1;
											$subject_code = $row2['subject_code'];
											$subject_desc = $row2['subject_desc'];
											$section = $row2['section'];
											$schedule_time1 = $row2['schedule_time1'];
											$schedule_time2 = $row2['schedule_time2'];
								...
								<h4>Finals Schedule (December 09, 2022) </h4>
								...
								<?php 
									$i = 0;
									$query3 = $query."AND term_period = '3'";
									$result3 = mysqli_query($con, $query3);							
									if(mysqli_num_rows($result3) > 0){
										while($row3 = mysqli_fetch_array($result3)){
											$i = $i + 1;
											$subject_code = $row3['subject_code'];
											$subject_desc = $row3['subject_desc'];
											$section = $row3['section'];
											$schedule_time1 = $row3['schedule_time1'];
											$schedule_time2 = $row3['schedule_time2'];
								...
								<input type='submit' name="save" value='Submit' title='Submit the Form' ></input>
								<input type='submit' name="reset" value='Reset' title='Clear your Submitted Data' ></input>
							</div>
