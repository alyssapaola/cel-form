	...
	<body>
		...
		<header id="header" class="fixed-top d-flex align-items-center header-transparent">
			...
			<div class="container d-flex align-items-center">
				<h1 class="logo me-auto"><a href="finals-view.php">Center for Technology-Enabled Education</a></h1>
						...
						<form method="post" action="" role="form" class="php-email-form" enctype="multipart/form-data">
							...
							<div class="mb-3" style="">
								...
								<p style="margin-top:10px; font-size:11pt;">
									...
									<span class="info-flip"><a href="review.php">No</a></span>
									<span class="info-flip"><a href="midterm-view.php">Back</a></span>
								</p>
							</div>
		...
		$("#getButtonValue").click(function () {
			...
			if (cnt_txtbox != 0){
				...
				if(confirm("Are you sure you want to submit this schedule?")){
					$.ajax({
					   type: "POST",
					   url: "components/insert-finals.php",
					   data: { arr: arr },
